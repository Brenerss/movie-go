...
import (
	...
	"brenerss.com/greenlight/internal/validator"
...
func (m UserModel) GetByEmail(email string) (*User, error) {
	...
	err := m.DB.QueryRowContext(ctx, query, email).Scan(&user.ID, &user.CreatedAt, &user.Version)
	if err != nil {
		switch {
		case err.Error() == `pq: no rows in result set`:
